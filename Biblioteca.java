...
public class Biblioteca {
    ...
    /**
     * Constructor que recibe una lista de libros. Se añaden al HashMap en el
     * constructor
     * 
     * @param nombre       Nombre de la biblioteca
     * @param listaEntrada Lista de libros
     */
    ...
    /**
     * Función para añadir libros a la biblioteca. Si el genero no existe, se crea
     * una nueva lista para ese genero
     * 
     * @param libro Libro a settear
     */
    ...
    /**
     * Función para obtener los libros de un genero concreto. Si el genero no
     * existe, devuelve null
     * 
     * @param genero Genero del libro
     * @return Lista con los libros de ese genero, si existe, o null
     */
    ...
    /**
     * Función para obtener los libros posteriores a un año concreto. Si el genero
     * no existe, devuelve null
     * 
     * @param añoPublicacion Año de publicacion del libro
     * @return Lista de libros posteriores a fecha
     */
     ...
     * .flatMap(lista -> lista.stream()) // 2. Unimos todas las listas en un solo
     * flujo
